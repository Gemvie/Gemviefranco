...
const footerLinks = [
  {
    title: "YouTube",
    href: "https://www.youtube.com/@GemvieAiza",
  },
  {
    title: "Instagram",
    href: "https://www.instagram.com/gemviefrank/",
  },
  {
    title: "LinkedIn",
...
export const Footer = () => {
  return (
    <footer className="relative overflow-x-clip">
      <div
        className="absolute h-[400px] w-[1600px] bottom-0 left-1/2 -translate-x-1/2 bg-cyan-300/30
